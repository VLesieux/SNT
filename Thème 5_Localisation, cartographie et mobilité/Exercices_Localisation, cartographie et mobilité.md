...
2) En utilisant l'algorithme de Dijkstra explicité [ici](http://vfsilesieux.free.fr/Dijkstra.pdf) dont l'implémentation en Python est donnée ci-dessous, retrouver le plus court chemin de A à B.
