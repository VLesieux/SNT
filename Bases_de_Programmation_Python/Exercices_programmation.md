...
Il est demandé d'écrire les docstring pour toutes les fonctions en écrivant quelques résultats escomptés en sortie et de les vérifier en l'important le `doctest` importé avec le code ci-dessous.
