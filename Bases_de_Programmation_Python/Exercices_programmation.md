...
Il est demandé d'écrire les docstring pour toutes les fonctions réalisés en écrivant quelques résultats escomptés en sortie et de les vérifier en important le module `doctest` avec le code ci-dessous.
