...
Les réseaux sociaux sont souvent critiqués par leur manque de respect de la vie privée de ses utilisateurs. Beaucoup de réseaux sociaux collectent des informations sur leurs utilisateurs pour ensuite les revendre ou les utiliser à des fins commerciales ou politiques. Le [scandale Facebook-Cambridge Analytica](Assets/How_to_turn_Facebook_into_a_weaponised_AI_propaganda_machine_New Scientist.pdf)  est une illustration : la société Cambridge Analytica a collecté les informations personnelles de millions d'utilisateurs Facebook dans le but d'influencer des intentions de vote, notamment lors des élections présidentielles américaines.
